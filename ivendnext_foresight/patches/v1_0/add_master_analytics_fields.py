...
def install_custom_fields():
    ...
    try:
        ...
        frappe.reload_doc("ivendnext_foresight", "custom", "customer", force=True)
        frappe.reload_doc("ivendnext_foresight", "custom", "item", force=True)
        ...
        try:
            customer_fixture_path = frappe.get_app_path("ivendnext_foresight", "ivendnext_foresight", "custom", "customer.json")
        ...
        try:
            item_fixture_path = frappe.get_app_path("ivendnext_foresight", "ivendnext_foresight", "custom", "item.json")
