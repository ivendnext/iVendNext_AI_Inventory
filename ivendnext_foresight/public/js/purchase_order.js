    ...
    frm.doc.items.forEach((item, index) => {
        if (item.item_code) {
            let promise = new Promise((resolve) => {
                frappe.call({
                    method: 'ivendnext_foresight.ml_supplier_analyzer.predict_purchase_price',
                    args: {
...
function update_forecasts_preview(dialog) {
    ...
    frappe.call({
        method: 'ivendnext_foresight.ivendnext_foresight.doctype.ai_inventory_forecast.ai_inventory_forecast.get_forecasts_for_supplier',
        args: {
...
frappe.provide('ivendnext_foresight.ivendnext_foresight.doctype.ai_inventory_forecast.ai_inventory_forecast');
