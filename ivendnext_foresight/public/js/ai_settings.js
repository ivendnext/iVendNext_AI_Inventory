...
function run_ml_supplier_analysis(frm) {
    ...
    frappe.call({
        ...
        callback: function(companies_result) {
            ...
            frappe.call({
                method: 'ivendnext_foresight.ml_supplier_analyzer.get_companies_with_purchase_data',
                callback: function(r) {
...
function create_sample_purchase_data(company) {
    frappe.confirm(
        ...
        function() {
            ...
            frappe.call({
                method: 'ivendnext_foresight.ml_supplier_analyzer.create_sample_purchase_data',
