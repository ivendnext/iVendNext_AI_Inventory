...
from ivendnext_foresight.utils.currency_utils import get_report_currency, format_currency
...
class AIFinancialForecast(Document):
        ...
        try:
            ...
            if alerts:
                for alert in alerts:
                    ...
                    try:
                        from ivendnext_foresight.ivendnext_foresight.doctype.ai_financial_alert.ai_financial_alert import create_financial_alert
    ...
    def initiate_comprehensive_sync(self):
        ...
        try:
            ...
            from ivendnext_foresight.ivendnext_foresight.utils.sync_manager import AIFinancialForecastSyncManager
            ...
            if self.auto_sync_enabled:
                if self.sync_frequency == "Manual":
                    ...
                    frappe.enqueue(
                        'ivendnext_foresight.forecasting.sync_manager.trigger_manual_sync',
                        queue='long',
                        timeout=300,
    ...
    def manual_sync(self):
        ...
        try:
            from ivendnext_foresight.forecasting.sync_manager import trigger_manual_sync
    ...
    def run_validation_check(self):
        ...
        try:
            from ivendnext_foresight.ivendnext_foresight.validation.forecast_validation import validate_specific_forecast
