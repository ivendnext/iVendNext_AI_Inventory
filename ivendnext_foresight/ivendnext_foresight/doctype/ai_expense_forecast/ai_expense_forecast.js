...
function sync_to_financial_forecast(frm) {
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.doctype.ai_expense_forecast.ai_expense_forecast.sync_with_financial_forecast",
        args: {
...
function analyze_expense_trends(frm) {
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.doctype.ai_expense_forecast.ai_expense_forecast.analyze_expense_trends",
        args: {
            expense_name: frm.doc.name
        },
        callback: function(r) {
...
function calculate_risk_factors(frm) {
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.doctype.ai_expense_forecast.ai_expense_forecast.calculate_expense_risks",
        args: {
            expense_name: frm.doc.name
        },
        callback: function(r) {
