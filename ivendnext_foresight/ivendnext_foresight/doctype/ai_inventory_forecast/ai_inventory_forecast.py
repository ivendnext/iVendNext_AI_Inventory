...
class AIInventoryForecast(Document):
    ...
    def set_preferred_supplier_safe(self):
        ...
        try:
            ...
            try:
                from ivendnext_foresight.ml_supplier_analyzer import MLSupplierAnalyzer
    ...
    def queue_forecast_update(self):
        ...
        try:
            frappe.enqueue(
                'ivendnext_foresight.ivendnext_foresight.doctype.ai_inventory_forecast.ai_inventory_forecast.run_forecast_background',
    ...
    def queue_auto_po_creation(self):
        ...
        try:
            frappe.enqueue(
                'ivendnext_foresight.ivendnext_foresight.doctype.ai_inventory_forecast.ai_inventory_forecast.create_auto_po_background',
                forecast_name=self.name,
                queue='short',
                timeout=300,
                is_async=True
