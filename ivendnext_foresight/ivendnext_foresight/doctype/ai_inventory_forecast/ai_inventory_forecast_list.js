...
frappe.listview_settings['AI Inventory Forecast'] = {
    ...
    onload: function(listview) {
        ...
        listview.page.add_action_item(__("🔄 Refresh Forecasts"), function() {
            frappe.call({
                method: "ivendnext_foresight.ivendnext_foresight.doctype.ai_inventory_forecast.ai_inventory_forecast.sync_ai_inventory_forecasts_now",
                callback: function(r) {
        ...
        listview.page.add_action_item(__("📦 Purchase Orders"), function() {
            frappe.call({
                method: "ivendnext_foresight.ivendnext_foresight.doctype.ai_inventory_forecast.ai_inventory_forecast.create_purchase_orders_from_forecasts",
                callback: function(r) {
                    if (r.message && r.message.status === "success") {
                        frappe.show_alert({
