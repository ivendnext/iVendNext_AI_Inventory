...
def generate_company_forecasts(company, forecast_types=None, forecast_period=90, settings=None):
    ...
    try:
        ...
        from ivendnext_foresight.ai_accounts_forecast.api.forecast_api import api_create_forecast
...
def run_system_health_check():
    ...
    try:
        from ivendnext_foresight.ai_accounts_forecast.api.forecast_api import get_system_health
...
def generate_accuracy_tracking():
    ...
    try:
        ...
        from ivendnext_foresight.forecasting.sync_manager import create_accuracy_tracking
...
def get_financial_alerts_dashboard():
    ...
    try:
        from ivendnext_foresight.ivendnext_foresight.doctype.ai_financial_alert.ai_financial_alert import get_active_alerts
...
def trigger_alert_check():
    ...
    try:
        from ivendnext_foresight.scheduled_tasks import check_financial_alerts
