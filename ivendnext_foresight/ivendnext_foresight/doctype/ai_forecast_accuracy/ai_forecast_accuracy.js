...
function calculate_accuracy_metrics(frm) {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.doctype.ai_forecast_accuracy.ai_forecast_accuracy.calculate_metrics",
        args: {
...
function recalculate_accuracy(frm) {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.doctype.ai_forecast_accuracy.ai_forecast_accuracy.recalculate_accuracy",
        args: {
...
function generate_accuracy_report(frm) {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.doctype.ai_forecast_accuracy.ai_forecast_accuracy.generate_accuracy_report",
        args: {
...
function compare_forecast_performance(frm) {
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.doctype.ai_forecast_accuracy.ai_forecast_accuracy.compare_forecasts",
        args: {
            company: frm.doc.company,
...
function update_source_forecast(frm) {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.doctype.ai_forecast_accuracy.ai_forecast_accuracy.update_source_forecast",
        args: {
            accuracy_name: frm.doc.name,
