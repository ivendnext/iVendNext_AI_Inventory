...
function refresh_ai_forecasts(report) {
    ...
    frappe.call({
        method: "ivendnext_foresight.forecasting.scheduled_tasks.scheduled_forecast_generation",
        callback: function(r) {
            frappe.show_alert({
...
function show_analytics_dashboard(report) {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.report.ai_consolidated_predictive_insights.ai_consolidated_predictive_insights.get_predictive_insights",
...
function export_predictive_analysis(report) {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.report.ai_consolidated_predictive_insights.ai_consolidated_predictive_insights.export_predictive_data",
        args: { filters: filters },
        callback: function(r) {
...
function check_critical_alerts(report) {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.report.ai_consolidated_predictive_insights.ai_consolidated_predictive_insights.execute",
        args: { filters: filters },
        callback: function(r) {
...
window.quick_reorder_analysis_action = function() {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.report.ai_consolidated_predictive_insights.ai_consolidated_predictive_insights.perform_quick_reorder_analysis",
        args: { filters: filters },
        callback: function(r) {
...
window.revenue_opportunities_action = function() {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.report.ai_consolidated_predictive_insights.ai_consolidated_predictive_insights.identify_revenue_opportunities",
        args: { filters: filters },
        callback: function(r) {
...
window.risk_assessment_action = function() {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.report.ai_consolidated_predictive_insights.ai_consolidated_predictive_insights.assess_risk_factors",
        args: { filters: filters },
        callback: function(r) {
...
window.demand_forecasting_action = function() {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.report.ai_consolidated_predictive_insights.ai_consolidated_predictive_insights.forecast_demand",
        args: { filters: filters },
        callback: function(r) {
...
window.create_ai_purchase_order_action = function() {
    ...
    frappe.call({
        method: "ivendnext_foresight.ivendnext_foresight.report.ai_consolidated_predictive_insights.ai_consolidated_predictive_insights.preview_ai_purchase_order",
        args: { filters: filters },
        callback: function(r) {
...
function show_purchase_order_preview_dialog(preview_data) {
    ...
    const dialog = new frappe.ui.Dialog({
        ...
        primary_action: function() {
            ...
            frappe.call({
                method: "ivendnext_foresight.ivendnext_foresight.report.ai_consolidated_predictive_insights.ai_consolidated_predictive_insights.create_ai_purchase_order_from_preview",
                args: { 
