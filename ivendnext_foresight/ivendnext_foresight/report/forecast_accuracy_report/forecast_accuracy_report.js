...
frappe.query_reports["Forecast Accuracy Report"] = {
    ...
    "onload": function(report) {
        ...
        report.page.add_menu_item(__("Export to Excel"), function() {
            frappe.call({
                method: 'ivendnext_foresight.ivendnext_foresight.report.forecast_accuracy_report.forecast_accuracy_report.export_accuracy_report',
                args: {
...
function show_detailed_analysis(report) {
    ...
    frappe.call({
        method: 'ivendnext_foresight.ivendnext_foresight.report.forecast_accuracy_report.forecast_accuracy_report.generate_forecast_accuracy_report',
        args: {
