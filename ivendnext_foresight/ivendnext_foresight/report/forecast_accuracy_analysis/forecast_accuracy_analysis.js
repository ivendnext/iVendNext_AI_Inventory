...
function get_improvement_recommendations(report) {
	try {
		...
		frappe.call({
			method: "ivendnext_foresight.ivendnext_foresight.report.forecast_accuracy_analysis.forecast_accuracy_analysis.generate_accuracy_improvement_recommendations",
			args: {
				company: company,
				min_accuracy: 80
			},
