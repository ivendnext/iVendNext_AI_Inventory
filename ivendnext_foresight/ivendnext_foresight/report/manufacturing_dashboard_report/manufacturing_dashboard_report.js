...
frappe.query_reports["Manufacturing Dashboard Report"] = {
    ...
    "onload": function(report) {
        ...
        report.page.add_menu_item(__("Detailed Dashboard"), function() {
            ...
            frappe.call({
                method: 'ivendnext_foresight.ivendnext_foresight.report.manufacturing_dashboard_report.manufacturing_dashboard_report.generate_manufacturing_dashboard_report',
                args: {
        ...
        report.page.add_menu_item(__("Export Dashboard"), function() {
            ...
            frappe.call({
                method: 'ivendnext_foresight.ivendnext_foresight.report.manufacturing_dashboard_report.manufacturing_dashboard_report.export_manufacturing_dashboard',
                args: {
                    company: filters.company,
                    period_months: parseInt(filters.period_months) || 6,
                    format: 'excel'
