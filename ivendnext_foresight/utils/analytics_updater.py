...
def force_update_analytics():
    ...
    try:
        ...
        from ivendnext_foresight.ivendnext_foresight.report.ai_sales_dashboard.ai_sales_dashboard import (
        ...
        try:
            from ivendnext_foresight.ivendnext_foresight.report.ai_sales_dashboard.ai_sales_dashboard import execute
