...
class AISalesDashboard(Document):
    ...
    def on_update(self):
        ...
        if self.enable_auto_sync and self.has_value_changed("enable_auto_sync"):
            frappe.enqueue('ivendnext_foresight.forecasting.core.generate_forecasts',
                         queue='short',
                         timeout=300)
...
def sync_all_forecasts():
    ...
    try:
        from ivendnext_foresight.forecasting.sync_manager import sync_all_forecast_types
