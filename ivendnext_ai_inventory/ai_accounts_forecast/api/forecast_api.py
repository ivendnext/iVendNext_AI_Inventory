    ...
    try:
        ...
        if notification_type == 'account_update':
            ...
            if company and account:
                ...
                frappe.enqueue(
                    'ivendnext_ai_inventory.ai_accounts_forecast.api.forecast_api.trigger_forecast_update',
                    company=company,
                    account=account,
                    queue='short'
                )
...
def api_documentation():
    ...
    documentation = {
        ...
        'version': '1.0',
        'base_url': f"{frappe.utils.get_url()}/api/method/ivendnext_ai_inventory.ai_accounts_forecast.api.forecast_api",
        'endpoints': {
            'forecast_creation': {
                'api_create_forecast': {
                    'method': 'POST',
...
POST /api/method/ivendnext_ai_inventory.ai_accounts_forecast.api.forecast_api.api_create_forecast
{
...
2. Get Dashboard:
GET /api/method/ivendnext_ai_inventory.ai_accounts_forecast.api.forecast_api.api_get_dashboard?company=Company%20Name

3. Bulk Create:
POST /api/method/ivendnext_ai_inventory.ai_accounts_forecast.api.forecast_api.api_create_bulk_forecasts
{
    "company": "Company Name",
...
4. Get Analytics:
GET /api/method/ivendnext_ai_inventory.ai_accounts_forecast.api.forecast_api.api_get_analytics?company=Company%20Name&date_range=30&analysis_type=detailed
"""
