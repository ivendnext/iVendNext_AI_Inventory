...
def install_custom_fields():
    ...
    try:
        ...
        frappe.reload_doc("ivendnext_ai_inventory", "custom", "customer", force=True)
        frappe.reload_doc("ivendnext_ai_inventory", "custom", "item", force=True)
        ...
        try:
            customer_fixture_path = frappe.get_app_path("ivendnext_ai_inventory", "ivendnext_ai_inventory", "custom", "customer.json")
        ...
        try:
            item_fixture_path = frappe.get_app_path("ivendnext_ai_inventory", "ivendnext_ai_inventory", "custom", "item.json")
