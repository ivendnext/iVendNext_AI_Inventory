...
frappe.ui.form.on('AI Sales Dashboard', {
    refresh: function(frm) {
        ...
        frm.add_custom_button(__('Train Models'), function() {
            frappe.call({
                method: 'ivendnext_ai_inventory.forecasting.core.train_models',
                callback: function(r) {
        ...
        frm.add_custom_button(__('Generate Forecasts'), function() {
            frappe.call({
                method: 'ivendnext_ai_inventory.forecasting.core.generate_forecasts',
                callback: function(r) {
                    if (r.message.success) {
...
function load_dashboard_summary(frm) {
    frappe.call({
        method: 'ivendnext_ai_inventory.api.dashboard.get_dashboard_summary',
        callback: function(r) {
            if (r.message.success) {
