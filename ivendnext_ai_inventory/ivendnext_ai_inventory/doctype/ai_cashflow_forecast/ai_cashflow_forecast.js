...
function sync_to_financial_forecast(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_cashflow_forecast.ai_cashflow_forecast.sync_with_financial_forecast",
        args: {
...
function calculate_ai_predictions(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_cashflow_forecast.ai_cashflow_forecast.set_ai_predictions",
        args: {
            cashflow_name: frm.doc.name
        },
        callback: function(r) {
...
function validate_cash_requirements(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_cashflow_forecast.ai_cashflow_forecast.validate_cash_requirements",
        args: {
            cashflow_name: frm.doc.name
        },
        callback: function(r) {
...
function populate_from_gl(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_cashflow_forecast.ai_cashflow_forecast.populate_from_gl",
