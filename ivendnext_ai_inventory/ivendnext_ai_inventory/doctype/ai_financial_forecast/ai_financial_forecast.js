...
function trigger_manual_sync(frm) {
    ...
    frappe.call({
        method: "ivendnext_ai_inventory.forecasting.sync_manager.trigger_manual_sync",
        args: {
...
function sync_to_inventory_forecasts(frm) {
    ...
    frappe.call({
        method: "ivendnext_ai_inventory.forecasting.sync_manager.sync_single_forecast",
        args: {
...
function generate_new_forecast(frm) {
    frappe.confirm(
        ...
        function() {
            frappe.call({
                method: "ivendnext_ai_inventory.ai_accounts_forecast.api.forecast_api.api_create_forecast",
                args: {
                    company: frm.doc.company,
...
function view_forecast_analytics(frm) {
    ...
    // Load analytics data
    frappe.call({
        method: "ivendnext_ai_inventory.ai_accounts_forecast.api.forecast_api.get_forecast_analytics",
        args: {
...
function sync_with_inventory(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ai_accounts_forecast.api.forecast_api.sync_with_inventory",
        args: {
            company: frm.doc.company,
            account: frm.doc.account
        },
...
function export_forecast_data(frm) {
    let url = `/api/method/ivendnext_ai_inventory.ai_accounts_forecast.api.forecast_api.export_forecast_data?forecast_id=${frm.doc.name}`;
...
function update_current_balance(frm) {
    ...
    frappe.call({
        method: "ivendnext_ai_inventory.balance.current_balance_manager.update_balance",
        args: {
            company: frm.doc.company,
            account: frm.doc.account
        },
...
function check_system_health(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ai_accounts_forecast.api.forecast_api.get_system_health",
        args: {
            company: frm.doc.company
        },
        callback: function(r) {
