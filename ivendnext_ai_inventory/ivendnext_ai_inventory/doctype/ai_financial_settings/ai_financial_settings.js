...
function add_system_management_buttons(frm) {
    ...
    frm.add_custom_button(__("↺ Backfill Cashflow (from Financial)"), function() {
        frappe.call({
            method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.backfill_cashflow_forecasts",
            args: { limit: 100 },
            callback: function(r) {
    ...
    frm.add_custom_button(__("🔧 Cleanup Invalid Alert Links"), function() {
        frappe.call({
            method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_alert.ai_financial_alert.cleanup_invalid_forecast_references",
            callback: function(r) {
                if (r.message && r.message.success) {
                    frappe.show_alert({
    ...
    frm.add_custom_button(__("🔍 Debug Alert References"), function() {
        frappe.call({
            method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_alert.ai_financial_alert.debug_forecast_references",
            callback: function(r) {
                if (r.message && r.message.success) {
...
function generate_bulk_forecasts(frm, scope = 'all_companies') {
    frappe.confirm(
        ...
        function() {
            ...
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.generate_bulk_forecasts",
                args: {
                    scope: scope,
                    settings: frm.doc
                },
...
function generate_forecasts_by_company(frm) {
    let dialog = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            ...
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.generate_company_forecasts",
                args: {
...
function generate_forecasts_by_account_type(frm) {
    let dialog = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.generate_account_type_forecasts",
                args: {
...
function generate_quick_cash_flow_forecast(frm) {
    frappe.confirm(
        ...
        function() {
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.generate_quick_cash_flow",
                args: {
                    settings: frm.doc
                },
                callback: function(r) {
...
function generate_revenue_forecast(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.generate_revenue_forecasts",
        args: {
            settings: frm.doc
        },
        callback: function(r) {
...
function generate_expense_forecast(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.generate_expense_forecasts",
        args: {
            settings: frm.doc
        },
        callback: function(r) {
...
function run_system_health_check(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.run_system_health_check",
        callback: function(r) {
            if (r.message) {
...
function sync_all_forecasts(frm) {
    frappe.confirm(
        ...
        function() {
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.sync_all_forecasts",
                callback: function(r) {
                    if (r.message && r.message.success) {
                        frappe.show_alert({
...
function sync_all_to_inventory(frm) {
    frappe.confirm(
        ...
        function() {
            ...
            frappe.call({
                method: "ivendnext_ai_inventory.forecasting.sync_manager.bulk_sync_to_inventory",
                callback: function(r) {
                    if (r.message && r.message.success) {
                        frappe.show_alert({
...
function cleanup_old_forecast_data(frm) {
    let dialog = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.cleanup_old_data",
                args: {
...
function show_model_performance_report(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.get_model_performance_report",
        callback: function(r) {
            if (r.message) {
...
function export_system_report(frm) {
    let url = `/api/method/ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.export_system_report`;
...
function display_system_status(frm) {
    if (!frm.status_added) {
        frappe.call({
            method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.get_system_status",
            callback: function(r) {
                if (r.message) {
                    let status_html = `
...
function sync_all_forecasts(frm) {
    frappe.confirm(
        ...
        function() {
            ...
            frappe.call({
                method: "ivendnext_ai_inventory.forecasting.sync_manager.sync_all_forecasts",
                args: {
...
function check_sync_status(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.forecasting.sync_manager.get_sync_status",
        args: {
            company: null,
            days: 7
        },
...
function check_comprehensive_sync_status(frm) {
    ...
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.get_comprehensive_sync_status",
        callback: function(r) {
            if (r.message && r.message.success) {
...
function force_rebuild_all_forecasts(frm) {
    frappe.confirm(
        ...
        function() {
            ...
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.force_rebuild_all_forecasts",
                callback: function(r) {
                    if (r.message && r.message.success) {
                        frappe.show_alert({
...
function check_sync_queue_status(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.get_sync_queue_status",
        callback: function(r) {
            if (r.message && r.message.success) {
...
function force_sync_specific_forecast(frm) {
    let dialog = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            frappe.call({
                method: "ivendnext_ai_inventory.forecasting.sync_manager.force_sync_specific_forecast",
                args: {
                    forecast_type: values.forecast_type,
                    company: values.company,
...
function generate_accuracy_tracking(frm) {
    frappe.confirm(
        ...
        function() {
            ...
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.generate_accuracy_tracking",
                callback: function(r) {
                    if (r.message && r.message.success) {
                        frappe.show_alert({
...
function view_accuracy_summary(frm) {
    let dialog = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.get_accuracy_summary",
                args: {
                    company: values.company,
                    days: values.days
                },
...
function test_sync_functionality(frm) {
    frappe.confirm(
        ...
        function() {
            ...
            frappe.call({
                method: "ivendnext_ai_inventory.sync_test_functions.test_sync_single_forecast",
                callback: function(r) {
                    if (r.message) {
...
function update_forecast_accuracy(frm) {
    let dialog = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.update_accuracy_with_actuals",
                args: {
...
function execute_master_sync_steps(dialog) {
    ...
    function processStep(index) {
        ...
        // Call sync function
        frappe.call({
            method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.master_sync_forecast_type",
            args: {
...
function trigger_financial_alert_check(frm) {
    frappe.confirm(
        ...
        function() {
            ...
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.trigger_alert_check",
                callback: function(r) {
                    if (r.message && r.message.success) {
                        frappe.show_alert({
...
function view_financial_alerts_dashboard(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.get_financial_alerts_dashboard",
        callback: function(r) {
            if (r.message && r.message.success) {
...
function create_financial_alert_doctype(frm) {
    frappe.confirm(
        ...
        function() {
            ...
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.create_alert_doctype",
                callback: function(r) {
                    if (r.message && r.message.success) {
                        frappe.show_alert({
...
function setup_ai_financial_settings_automation(frm) {
    frappe.confirm(
        ...
        function() {
            ...
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.setup_automation",
                args: {
...
function manage_ai_financial_alerts(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.get_all_financial_alerts",
        callback: function(r) {
            if (r.message && r.message.success) {
...
function force_sync_all_from_dialog() {
    ...
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.force_sync_all_forecasts",
        callback: function(r) {
            if (r.message && r.message.success) {
                frappe.show_alert({
...
function clear_sync_queue() {
    frappe.confirm(
        ...
        function() {
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.clear_sync_queue",
                callback: function(r) {
                    frappe.show_alert({
...
function process_queue_now() {
    frappe.confirm(
        ...
        function() {
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.process_sync_queue",
                callback: function(r) {
                    frappe.show_alert({
...
function remove_from_queue(item_id) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.remove_from_sync_queue",
...
function bulk_resolve_alerts() {
    frappe.confirm(
        ...
        function() {
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.bulk_resolve_alerts",
                callback: function(r) {
                    frappe.show_alert({
...
function export_alerts_report() {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_financial_settings.ai_financial_settings.export_alerts_report",
        callback: function(r) {
            if (r.message && r.message.success) {
