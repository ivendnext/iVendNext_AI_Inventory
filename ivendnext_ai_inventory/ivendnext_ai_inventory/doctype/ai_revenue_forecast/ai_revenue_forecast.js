...
function sync_to_financial_forecast(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_revenue_forecast.ai_revenue_forecast.sync_with_financial_forecast",
        args: {
...
function analyze_growth_trends(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_revenue_forecast.ai_revenue_forecast.analyze_growth_trends",
        args: {
            revenue_name: frm.doc.name
        },
        callback: function(r) {
...
function calculate_historical_accuracy(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_revenue_forecast.ai_revenue_forecast.calculate_historical_accuracy",
        args: {
            revenue_name: frm.doc.name
        },
        callback: function(r) {
...
function set_inventory_integration(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_revenue_forecast.ai_revenue_forecast.set_inventory_integration",
        args: {
            revenue_name: frm.doc.name
        },
        callback: function(r) {
...
function populate_from_sales(frm) {
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.doctype.ai_revenue_forecast.ai_revenue_forecast.populate_from_sales",
        args: {
            revenue_name: frm.doc.name
        },
        callback: function(r) {
