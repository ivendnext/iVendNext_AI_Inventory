...
function show_ai_insights_dialog(report) {
    ...
    frappe.call({
        method: "ivendnext_ai_inventory.ivendnext_ai_inventory.report.ai_sales_dashboard.ai_sales_dashboard.get_forecast_insights",
...
function create_bulk_sales_orders(report) {
    ...
    frappe.confirm(
        ...
        function() {
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.report.ai_sales_dashboard.ai_sales_dashboard.create_bulk_sales_orders",
...
function update_bulk_forecasts(report) {
    ...
    frappe.confirm(
        ...
        function() {
            frappe.call({
                method: "ivendnext_ai_inventory.ivendnext_ai_inventory.report.ai_sales_dashboard.ai_sales_dashboard.update_bulk_forecasts",
                args: {forecast_ids: forecast_ids},
                callback: function(r) {
                    if (r.message && r.message.success) {
                        frappe.show_alert({
