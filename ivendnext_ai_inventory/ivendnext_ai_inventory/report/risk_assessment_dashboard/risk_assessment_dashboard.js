...
frappe.query_reports["Risk Assessment Dashboard"] = {
    ...
    "onload": function(report) {
        ...
        report.page.add_menu_item(__("Risk Matrix"), function() {
            ...
            frappe.call({
                method: 'ivendnext_ai_inventory.ivendnext_ai_inventory.report.risk_assessment_dashboard.risk_assessment_dashboard.generate_risk_assessment_dashboard',
                args: {
        ...
        report.page.add_menu_item(__("Export Risk Report"), function() {
            ...
            frappe.call({
                method: 'ivendnext_ai_inventory.ivendnext_ai_inventory.report.risk_assessment_dashboard.risk_assessment_dashboard.export_risk_assessment',
                args: {
                    company: filters.company,
                    period_months: parseInt(filters.period_months) || 6,
                    format: 'excel'
