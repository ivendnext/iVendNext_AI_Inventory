...
frappe.query_reports["Revenue Trend Analysis Report"] = {
    ...
    "onload": function(report) {
        ...
        report.page.add_menu_item(__("Revenue Breakdown"), function() {
            ...
            frappe.call({
                method: 'ivendnext_ai_inventory.ivendnext_ai_inventory.report.revenue_trend_analysis_report.revenue_trend_analysis_report.get_revenue_breakdown',
                args: {
        ...
        report.page.add_menu_item(__("Growth Analysis"), function() {
            ...
            frappe.call({
                method: 'ivendnext_ai_inventory.ivendnext_ai_inventory.report.revenue_trend_analysis_report.revenue_trend_analysis_report.get_growth_analysis',
                args: {
                    company: filters.company,
                    period_months: parseInt(filters.period_months) || 18
                },
        ...
        report.page.add_menu_item(__("Seasonal Analysis"), function() {
            ...
            frappe.call({
                method: 'ivendnext_ai_inventory.ivendnext_ai_inventory.report.revenue_trend_analysis_report.revenue_trend_analysis_report.get_seasonal_analysis',
                args: {
                    company: filters.company
                },
                callback: function(r) {
        ...
        report.page.add_menu_item(__("Export Report"), function() {
            ...
            frappe.call({
                method: 'ivendnext_ai_inventory.ivendnext_ai_inventory.report.revenue_trend_analysis_report.revenue_trend_analysis_report.export_revenue_trend_report',
                args: {
                    company: filters.company,
                    period_months: parseInt(filters.period_months) || 18,
                    format: 'excel'
