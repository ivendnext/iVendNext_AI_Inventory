...
function get_improvement_recommendations(report) {
	try {
		...
		frappe.call({
			method: "ivendnext_ai_inventory.ivendnext_ai_inventory.report.forecast_accuracy_analysis.forecast_accuracy_analysis.generate_accuracy_improvement_recommendations",
			args: {
				company: company,
				min_accuracy: 80
			},
