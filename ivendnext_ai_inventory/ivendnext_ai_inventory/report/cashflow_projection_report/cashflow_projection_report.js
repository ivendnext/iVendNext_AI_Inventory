...
frappe.query_reports["Cashflow Projection Report"] = {
    ...
    "onload": function(report) {
        ...
        report.page.add_inner_button(__("Export to Excel"), function() {
            ...
            frappe.call({
                method: 'ivendnext_ai_inventory.ivendnext_ai_inventory.report.cashflow_projection_report.cashflow_projection_report.export_report',
                args: {
                    filters: filters,
                    format: 'excel'
                },
        ...
        report.page.add_inner_button(__("Email Report"), function() {
            ...
            frappe.prompt([
                ...
                frappe.call({
                    method: 'ivendnext_ai_inventory.ivendnext_ai_inventory.report.cashflow_projection_report.cashflow_projection_report.email_report',
                    args: {
                        filters: filters,
        ...
        report.page.add_inner_button(__("Generate Dashboard"), function() {
            let filters = report.get_values();
            frappe.call({
                method: 'ivendnext_ai_inventory.ivendnext_ai_inventory.report.cashflow_projection_report.cashflow_projection_report.create_dashboard_charts',
                args: {
                    filters: filters
                },
                callback: function(r) {
        ...
        report.page.add_inner_button(__("Scenario Analysis"), function() {
            let filters = report.get_values();
            frappe.call({
                method: 'ivendnext_ai_inventory.ivendnext_ai_inventory.report.cashflow_projection_report.cashflow_projection_report.get_scenario_analysis_data',
                args: {
                    filters: filters
                },
                callback: function(r) {
